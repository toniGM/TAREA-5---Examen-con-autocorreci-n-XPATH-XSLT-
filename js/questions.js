...
function comprobar(){
	...
	if (document.getElementById("text1").value == "") {
		...
		return false;
	} else if (document.getElementById("mySel1").selectedIndex == -1){
		...
		alert("Selecciona una opción selectmultiple de la pregunta 9");
		...
		alert("Selecciona una opción del radio de la pregunta 10");
		return false;
	}
	else return true;
}
